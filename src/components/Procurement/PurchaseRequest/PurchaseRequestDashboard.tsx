...
const PurchaseRequestDashboard: React.FC = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3 mb-3">
      <div>
        <h1 className="text-lg font-semibold text-gray-900">Purchase Request (PR)</h1>
        <p className="text-sm text-gray-500">
          Create and manage material requisitions from site
        </p>
      </div>
      ...
      <CreatePR isOpen={openModal} onClose={() => setOpenModal(false)} />
      {/*  */}
    </div>
  );
};
