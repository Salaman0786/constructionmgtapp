...
const ProjectCostControl: React.FC = () => {
  return (
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500">
            Manage project cost breakdown and tracking
          </p>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-3">
          <select className="border border-gray-200 rounded-lg px-4 py-2 text-sm text-[#4b0082] focus:outline-none focus:ring-2 focus:ring-indigo-500">
            <option>Residential Complex Phase 1</option>
            <option>Commercial Plaza Development</option>
          </select>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-white border rounded-xl p-4 shadow-sm flex items-center justify-between">
          <div className="flex flex-col items-start gap-3">
            ...
            <h4 className="text-lg font-semibold text-gray-800">$5,000,000</h4>
          </div>
        ...
        <div className="bg-white border rounded-xl p-4 shadow-sm flex items-center justify-between">
          <div className="flex flex-col items-start gap-3">
            <p className="text-sm text-gray-500">Committed Costs</p>
            <h4 className="text-lg font-semibold text-gray-800">$3,200,000</h4>
          </div>
        ...
        <div className="bg-white border rounded-xl p-4 shadow-sm flex items-center justify-between">
          <div className="flex flex-col items-start gap-3">
            ...
            <h4 className="text-lg font-semibold text-red-600">$2,150,000</h4>
          </div>
        ...
        <div className="bg-white border rounded-xl p-4 shadow-sm flex items-center justify-between">
          <div className="flex flex-col items-start gap-3">
            ...
            <h4 className="text-lg font-semibold text-red-600">$1,800,000</h4>
          </div>
          <div className="bg-purple-100 p-2 rounded-full">
            <TriangleAlert className="text-red-600" />
          </div>
